...
public class MainActivity extends Activity {
    ...
    public void Jugar(View v){
        ...
        jugadores=1;
        //el metodo Jugar serÃ¡ llamado tanto en el botÃ³n de un jugador como en el de dos
        //por eso comprobamos la vista que entra como parÃ¡metro
    ...
    //creamos el mÃ©todo que se lanza al pulsar cada casilla
    public void toqueCasilla(View v){

        //hacemos que sÃ³lo se ejecute cuando la variable partida no sea null
        if(partida==null){
            return;
        }else{
            int casilla=0;
           ...
           /* Toast mensaje= Toast.makeText(this,"has pulsado la casilla "+ casilla,Toast.LENGTH_LONG);
            ...
            //si la casilla pulsada ya estÃ¡ ocupada salimos del mÃ©todo
            if(partida.casilla_libre(casilla)==false){
                return;
            }
            //llamamos al mÃ©todo para marcar la casilla que se ha tocado
    ...
    private void terminar_partida(int res){
        ...
        if(res==1) mensaje="Han ganado los cÃ­rculos";
